...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        box = new THREE.Line(geometry, materialPoint);
        box.position.x = 2.0;
        box.position.z = 2.0;
        scene.add(box);
        // sphere
        geometry = new THREE.SphereGeometry(1.5, 16, 16);
        sphere = new THREE.Points(geometry, materialPoint);
        sphere.position.x = 2.0;
        sphere.position.z = -2.0;
        scene.add(sphere);
        // cone
        geometry = new THREE.ConeGeometry(1.0, 1.5, 32);
        cone = new THREE.Points(geometry, materialPoint);
        cone.position.x = -2.0;
        cone.position.z = 2.0;
        scene.add(cone);
        // torus
        geometry = new THREE.TorusGeometry(1.0, 0.4, 32, 32);
        torus = new THREE.Skinnedmesh(geometry, materialPoint);
